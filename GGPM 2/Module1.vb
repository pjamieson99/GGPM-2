Module Module1
    ...
    Public NumOfIterations As Integer = 100
    ...
    Sub Test()
        ...
        Do
            ...
            For y = 0 To 2 'converts the board state to user friendly display
                If State(0, y) = "." Then
                    Pos1 = " "
            ...
            Console.WriteLine("Please give X coordinate of your move please: ") 'gets position of player's move
            n = Console.ReadLine()
            Console.WriteLine("Please give Y coordinate of your move please: ")
            m = Console.ReadLine()
            State(n, m) = "-1"

            Net.CheckAction = State.Clone
            Net.CheckWin() 'checks if game is over and resets board if so
            If Net.XWin Or Net.OWin Then
