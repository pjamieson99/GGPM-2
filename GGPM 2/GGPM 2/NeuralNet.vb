Public Class NeuralNet
    ...
    Public XWin As Boolean 'these are booleans stating which side won
    Public OWin As Boolean
    ...
    Public CheckAction(2, 2) As String
    ...
    Sub SetUpTrainingBatch() 'find the training batch values
        Exploration = Rnd.Next(0, NumOfIterations) / NumOfIterations
